...
! function(t) {
    ...
    window.tram = function(t) {
        ...
        var l = function(t, e, n) {
            ...
            z = e.support = { bind: Function.prototype.bind, transform: R("transform"), transition: R("transition"), backface: R("backface-visibility"), timing: R("transition-timing-function") };
        if (z.transition) {
            var D = z.timing.dom;
            if (A.style[D] = f["ease-in-back"][0], !A.style[D])
                for (var P in d) f[P][0] = d[P]
        }
        var I = e.frame = function() { var t = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame; return t && z.bind ? t.bind(p) : function(t) { p.setTimeout(t, 16) } }(),
            M = e.now = function() {
                var t = p.performance,
                    e = t && (t.now || t.webkitNow || t.msNow || t.mozNow);
                return e && z.bind ? e.bind(t) : Date.now || function() { return +new Date }
            }(),
            j = l(function(e) {
                function r(t, e) {
                    var n = function(t) {
            ...
            W = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (I(n), e = M(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = M()), this.active = !0, t = this, 1 === u.push(t) && I(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        var G = t.style,
            ...
            K = {};
        z.transform && (Y.transform = [q], K = { x: [x, "translateX"], y: [x, "translateY"], rotate: [k], rotateX: [k], rotateY: [k], scale: [g], scaleX: [g], scaleY: [g], skew: [k], skewX: [k], skewY: [k] }), z.transform && z.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [g], K.perspective = [y]);
        var Q = /ms/,
            J = /s|\./;
        return t.tram = e
    }(window.jQuery)
}, function(t, e) { t.exports = function(t) { return t && t.__esModule ? t : { default: t } } }, function(t, e, n) { n(4), n(7), n(8), n(9), n(10), n(11), n(16), t.exports = n(19) }, function(t, e, n) {
    "use strict";
    var i = n(0);
        ...
        var r, o = t(window),
            ...
            c = n.load || function() {
                r = !0, window.WebflowEditor = !0, o.off(u, f),
                    ...
                    }(function(e) { t.ajax({ url: m("https://editor-api.webflow.com/api/editor/view"), data: { siteId: a.attr("data-iq-site") }, xhrFields: { withCredentials: !0 }, dataType: "json", crossDomain: !0, success: d(e) }) })
            },
            l = !1;
    ...
    r.define("forms", t.exports = function(t, e) {
        ...
        function E(e) {
            ...
            }(n), k(e), o ? t.ajax({ url: s, type: "POST", data: i, dataType: "json", crossDomain: !0 }).done(function(t) { t && 200 === t.code && (e.success = !0), T(e) }).fail(function() { T(e) }) : T(e)
        }
        ...
        return c.ready = c.design = c.preview = function() {
            ! function() {
                o = t("html").attr("data-iq-site"), s = "https://webflow.com/api/v1/form/" + o, d && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "http://formdata.webflow.com"));
        ...
        function T(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), S(a), s ? (C(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = f.width();
                    S(t), !0 === i.open && F(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function() { r !== f.width() && z(t) })
                }
            }(a))) : (! function(e) {
                if (e.overlay) return;
                e.overlay = t(v).appendTo(e.el), e.overlay.attr("id", e.overlayContainerId), e.parent = e.menu.parent(), q(e, !0)
            }(a), a.button.on("click" + m, D(a)), a.menu.on("click" + m, "a", P(a)), a.button.on("keydown" + m, function(t) {
                return function(e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
        ...
        function F(t, e) {
            if (!t.open) {
                ...
                var r = N(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (M(0, c), k.intro(0, c), i.redraw.up(), s || d.on("click" + m, t.outside), e) p();
                else {
    ...
    i.define("gplus", t.exports = function(t) {
        var e, n = t(document),
            r = {};
        return r.ready = function() { i.env() || e || n.find(".w-widget-gplus").length && (e = !0, console.warn("Google Plus shut down in April 2019 (https://support.google.com/plus/answer/9195133). Please remove the Google Plus element.")) }, r
    })
}]);